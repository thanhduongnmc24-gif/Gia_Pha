...
export default function SettingsScreen() {
  ...
  const getCycleTypeConfig = (type: string) => {
    switch (type) {
      case 'ngay': return { icon: 'sunny', color: '#F59E0B', bg: theme === 'dark' ? '#F59E0B20' : '#FEF3C7', label: 'Ngày' };
      case 'dem': return { icon: 'moon', color: '#6366F1', bg: theme === 'dark' ? '#6366F120' : '#E0E7FF', label: 'Đêm' };
      case 'nghi': return { icon: 'cafe', color: '#10B981', bg: theme === 'dark' ? '#10B98120' : '#D1FAE5', label: 'Nghỉ' };
        ...
        <View style={{paddingHorizontal: 15}}>
          ...
          <View style={[dynamicStyles.card, {padding: 10}]}>
             ...
             <View style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10}}>
                <TouchableOpacity style={[dynamicStyles.addCycleBtn, {backgroundColor: theme === 'dark' ? '#F59E0B20' : '#FEF3C7'}]} onPress={() => addToPattern('ngay')}>
                    <Ionicons name="sunny" size={24} color="#F59E0B" /><Text style={{fontSize: 11, fontWeight:'bold', color: '#B45309', marginTop: 2}}>+ Ngày</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[dynamicStyles.addCycleBtn, {backgroundColor: theme === 'dark' ? '#6366F120' : '#E0E7FF'}]} onPress={() => addToPattern('dem')}>
                    <Ionicons name="moon" size={24} color="#6366F1" /><Text style={{fontSize: 11, fontWeight:'bold', color: '#4338CA', marginTop: 2}}>+ Đêm</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[dynamicStyles.addCycleBtn, {backgroundColor: theme === 'dark' ? '#10B98120' : '#D1FAE5'}]} onPress={() => addToPattern('nghi')}>
